...
export default function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      {error && (
      <div className="bg-red-600 bg-opacity-45   text-white px-4 py-3 rounded" role="alert">
        <span className="block sm:inline font-light">{error}</span>
      </div>
    )}
      <div className="w-full max-w-md p-8 space-y-6">
        <button 
          className="w-full py-2 text-gray-700 border border-gray-300 rounded-full bg-white flex items-center justify-center"
        >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-sm font-extralight text-white"></label>
            <input 
              type="text" 
              id="username"
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-extralight text-white"></label>
            <input 
              type="password" 
              id="password"
          ...
          <button type="submit" className="w-full py-1 text-white rounded-full font-light hover:font-normal">
            log in
          </button>
        </form>
