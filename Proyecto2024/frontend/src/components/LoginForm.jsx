...
export default function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      {error && (
        <div
          className="bg-red-600 bg-opacity-45   text-white px-4 py-3 rounded"
          role="alert"
        >
      ...
      <div className="w-full max-w-md p-8 space-y-6">
        <button className="w-full py-2 text-gray-700 border border-gray-300 rounded-full bg-white flex items-center justify-center">
          <svg
