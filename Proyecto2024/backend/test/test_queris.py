...
class TestQueryEndpoints(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prediction1 = Prediction(
            user_id=self.test_user.id, result="Prediction 1", score=85
        )
        self.prediction2 = Prediction(
            user_id=self.test_user.id, result="Prediction 2", score=75
        )
